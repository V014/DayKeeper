...
namespace DayKeeper
{
    public partial class Add : UserControl
    {
        ...
        {
            title_lbl.Text = "Add Record";
            milin_txt.Text = "0";
            milout_txt.Text = "0";
            crew_txt.Text = "Kapera, Fatsani";
            fuel_txt.Text = "0";
            sales_txt.Text = "0";
            losses_txt.Text = "0";
            notes_txt.Text = "";
        ...
        private void save_btn_Click(object sender, EventArgs e)
        {
            ...
            if (result != "")
            {
                try
                {
                    ...
                    save.Play();
                    title_lbl.Text = "Record Updated!";
                    title_lbl.ForeColor = Color.FromArgb(0, 122, 204);
            ...
            else
            {
                try
                {
                    ...
                    SoundPlayer save = new SoundPlayer(@"click.wav");
                    save.Play();
                    title_lbl.Text = "Record Saved!";
                    title_lbl.ForeColor = Color.FromArgb(134, 251, 135);
                    save_btn.Text = "Saved!";
                }
                catch (Exception)
                {
